...
export default class PoliticianMakeAComment extends Component {
  ...
  render() {
    let subHeaderStyle = { fontFamily: 'Helvetica Black Extended', fontSize: '1.8em', color: 'white', textAlign: 'center', backgroundColor: 'black', marginBottom: '-0.2em' };
      ...
      return (
        <div>
          ...
          <form onSubmit={this.handleSubmit}>
            <Container style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', marginBottom: '3em' }}>
              <CustomTextField
